...
export default function Stage4_SubDirection() {
    ...
    return (
      <StageContainer title="Sub-Direction" subtitle="Refine your brand personality" stageNumber={4}>
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-lg text-gray-500 mb-2">No Brand Core selected</p>
          <p className="text-sm text-gray-400">Please go back and choose a Brand Core first.</p>
        </div>
      </StageContainer>
    );
  }
  ...
  return (
    <StageContainer
      ...
      stageNumber={4}
    >
      {/* Brand Core Identity Banner */}
      <motion.div
        initial={{ opacity: 0, y: -10 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="relative overflow-hidden rounded-2xl mb-10 p-6 md:p-8"
      ...
      {/* Sub-Direction Grid: 2 columns, 5th card spans or offsets */}
            ...
            <motion.button
              ...
              style={{
                ...
                boxShadow: isSelected
                  ? `0 20px 60px -15px ${coreData.colors.primary}40, 0 0 0 2px ${coreData.colors.primary}`
            ...
            >
              ...
              <div className="relative p-5 md:p-6">
                ...
                <p
                  ...
                  style={{
                    color: isSelected ? `${styles.selectedTextColor}B3` : coreData.colors.text,
                  }}
                >
                  {sub.desc}
                </p>
                ...
                <p
                  ...
                  style={{
                    ...
                    color: isSelected ? `${styles.selectedTextColor}90` : `${coreData.colors.text}99`,
                  }}
                >
                  {sub.visual}
                </p>
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: isSelected ? `${styles.selectedTextColor}80` : `${coreData.colors.text}90` }}
                  >
                    {sub.bestFor}
                  </p>
                </div>
      ...
      <AnimatePresence>
        {state.subDirection && (
          ...
          >
            <p className="text-sm" style={{ color: `${coreData.colors.text}90` }}>
              Selected:{' '}
